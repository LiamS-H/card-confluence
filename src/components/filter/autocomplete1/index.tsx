...
import { IAutocompleteNode } from '../../../types/interfaces/search/autcomplete';
...
export default function StringAutocomplete(props: {
    ...
    function genEsp(map: IAutocompleteNode, text: string, queryList?: string[]): string[] {
        ...
        if (isStringArray(map)) {
            queryList.push(text_lower);
            return map.filter((filter) => filter.startsWith(text_lower));
        }
